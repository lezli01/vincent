...
# (Amended 2026-09-17, task 115 decision 3: that arrangement is widened by one
...
tui:                           # view preference; the daemon validates and relays it (§15)
  ...
  keys: {}                     # operation id → one key, e.g. {refresh: ctrl+e}; {} = the §15 defaults (task 115)
```
...
*Amended 2026-09-17 (task 115, issue #412):* `tui.keys` rebinds the TUI's
...
task 115 decision 3 says so as an explicit amendment of task 046 decision 4;
...
*Amended 2026-09-17 (task 115, issue #412).* **The table above is the default
