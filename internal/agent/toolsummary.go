...
// every client would otherwise need the same guard. It is exported for a
// skill's arguments, which are the subject of a `Skill` call the way a
// command line is Bash's (task 124.2).
