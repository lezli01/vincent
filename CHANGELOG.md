...
* **agent:** carry a reported quota reading through to the wire ([a8dd642](https://github.com/lezli01/vincent/commit/a8dd64273d4584505deb08980b93b8c2eb6c2f39))
* **agent:** report codex's quota over app-server --stdio ([c9115ff](https://github.com/lezli01/vincent/commit/c9115ff0ed478144d9ac40f3bbe6246784a1a944))
* **agent:** resume codex and cursor sessions, so chats run on them ([86aea3c](https://github.com/lezli01/vincent/commit/86aea3c8989bed841648d516c3bafb3d1e9ccee6))
* **agent:** surface more of claude's stream-json in the output view ([24afaf9](https://github.com/lezli01/vincent/commit/24afaf951edf6550ed6bf36359f91f8b5c9a32d2))
* **api:** attribute a fan-out parent's diff to its lanes ([3bb6334](https://github.com/lezli01/vincent/commit/3bb6334dfbade7f5033a97996af184bb6d156b1c))
* **api:** report a loop's real extent and running body step ([2264b5a](https://github.com/lezli01/vincent/commit/2264b5af18e034095ee5982984fa8035bbc395b6))
* **api:** serve a task's own workflow snapshot ([16052db](https://github.com/lezli01/vincent/commit/16052db27ade631ff633593d0755249f9e90ff66))
* **chat:** free chat — conversational agent sessions beside tasks ([2bc2597](https://github.com/lezli01/vincent/commit/2bc25979ed6649e635d17a686d9ebaa60fb38046)), closes [#255](https://github.com/lezli01/vincent/issues/255)
* **chat:** hand a chat's worktree and branch to a task ([74f455b](https://github.com/lezli01/vincent/commit/74f455b68d2cff4d3aa5660257132268cdeb2720))
* **cli:** add `vincent statusline`, the claude quota push ([a3a3a7f](https://github.com/lezli01/vincent/commit/a3a3a7f0e1f68b156c4d357b679718e90edd3976))
* **cli:** install a verified release with `vincent update` ([13ed29d](https://github.com/lezli01/vincent/commit/13ed29df52fc8525ae19090054505d0722ebc13a))
* **cli:** report the release check in doctor and daemon status ([d0cfb56](https://github.com/lezli01/vincent/commit/d0cfb56930f268bd050b50c67b0c2792dcd914e3))
* **codex:** resume a thread, so chats work on codex ([dcfe84a](https://github.com/lezli01/vincent/commit/dcfe84a5864c87755ab7475ff930af8bcf2c9caa))
* **codex:** surface the plan, command output and full usage ([bbc8ad3](https://github.com/lezli01/vincent/commit/bbc8ad333c48078dd9a0d62077ae181157337505))
* **config:** edit the daemon configuration through the API, the CLI and the TUI ([a9de700](https://github.com/lezli01/vincent/commit/a9de700ac51059a1c616563e1671d9f8909b9307))
* **config:** edit the daemon configuration through the API, the CLI and the TUI ([f8fdbc2](https://github.com/lezli01/vincent/commit/f8fdbc26c45191925c30361638763a88a7d9a52f))
* **container:** run a task's steps inside a container ([1cfe5ab](https://github.com/lezli01/vincent/commit/1cfe5abaf789a8c9f3fbf69d36330fd6adc18f5e))
* **container:** serve and edit container.* through the config endpoint ([c9aafe9](https://github.com/lezli01/vincent/commit/c9aafe9eba92f1ce9136d38644d10158bd2f7f2a))
* **github:** create a task from a pull request, on the PR's head branch ([05a7331](https://github.com/lezli01/vincent/commit/05a73313b65a1d7434dd61aa79a368b48c050502))
* **github:** list a project's open pull requests and link them to tasks ([5c76fa6](https://github.com/lezli01/vincent/commit/5c76fa6980651f81006b4ff27f2da268780fa6c1))
* **github:** push a task's branch and open its pull request ([ac8eb18](https://github.com/lezli01/vincent/commit/ac8eb180c686acce42f9ab14d18810cb5cadb99d)), closes [#273](https://github.com/lezli01/vincent/issues/273)
* **mcp:** carry Idempotency-Key through the tool path ([401af7a](https://github.com/lezli01/vincent/commit/401af7a23fcfe08491446bbb5a1b8b34bf040357))
* **mcp:** serve MCP from the daemon so agents can drive vincent ([207f11a](https://github.com/lezli01/vincent/commit/207f11aeea6eae2c2fd4f0b04388615c229b1a58))
* **mcp:** serve MCP from the daemon so agents can drive vincent ([8715863](https://github.com/lezli01/vincent/commit/8715863cba34ffebf1b012f695b013ef6bb523ed))
* **release:** check GitHub for a newer stable release ([e7ed537](https://github.com/lezli01/vincent/commit/e7ed537eac20e2ce30aada22498e07de9e852b63))
* **store:** record a loop's planned extent on every body row ([ca18c3b](https://github.com/lezli01/vincent/commit/ca18c3bbc4be1c8fa9500d01e4b581fea52aadc0))
* **tui:** a chats board and a chat workspace, and the clocks a chat turn was missing ([465fc8d](https://github.com/lezli01/vincent/commit/465fc8db5b6cf670894f715c211710a7a534ca9b))
* **tui:** a pull-requests takeover and a browser opener ([4895975](https://github.com/lezli01/vincent/commit/489597511ff79644ab2b69b0d220d45971a49c42))
* **tui:** add a fourth output level, quiet, below compact ([ba297f0](https://github.com/lezli01/vincent/commit/ba297f068cc9d8ba4fd4f4050defcb1014ef89bd))
* **tui:** add a multi-line text pane beside textField ([073a5da](https://github.com/lezli01/vincent/commit/073a5dad09520c81e81f345959d67b4731c2c4b8))
* **tui:** add a raw view and copy actions for assistant Markdown ([4482ac5](https://github.com/lezli01/vincent/commit/4482ac53728b1127ced84a6b039f075a296ca03d))
* **tui:** add a task-details tab inside the three form popups ([faacabc](https://github.com/lezli01/vincent/commit/faacabc8eae220587cc65036560f88a8f49d3e60))
* **tui:** add a task-details tab inside the three form popups ([4802e57](https://github.com/lezli01/vincent/commit/4802e579cb71c22d002411a1988cb8fa3ae877c3))
* **tui:** add the Pull Request tab with live CI checks ([c74e871](https://github.com/lezli01/vincent/commit/c74e8717e2bfa970c273e0d98f02f8c2dba9502f))
* **tui:** add the Pull Request tab with live CI checks ([1815eae](https://github.com/lezli01/vincent/commit/1815eae931113a820568643359afbfcafd9ce4a6))
* **tui:** add the Workflow tab to the task workspace ([f9c2d87](https://github.com/lezli01/vincent/commit/f9c2d87dee795a7db81802be9f883f93b376e5c4))
* **tui:** cap the board TITLE column and wrap overflowing cells ([b3b9bb6](https://github.com/lezli01/vincent/commit/b3b9bb6c6f39497d9be80806c97eb76a24bc51f5))
* **tui:** create, edit and fork workflows through structured forms ([7b28a1f](https://github.com/lezli01/vincent/commit/7b28a1f1b12277756dabd1d104d2e7183713c5f9))
* **tui:** draw a task's run state on the workflow graph ([4b1fbb3](https://github.com/lezli01/vincent/commit/4b1fbb39a00a37a74ac1092d6ccbe6a6291b2f10))
* **tui:** draw the lane DAG and keep a derived list's provenance ([622c9ad](https://github.com/lezli01/vincent/commit/622c9ad4963d46e7f4bcf9af3b1401aacb52c90d))
* **tui:** fold groups on the task board ([df4c527](https://github.com/lezli01/vincent/commit/df4c527b4efc3b6dcd75638eb0a3b64685ea7c13))
* **tui:** give the chat a prompt bubble and a bordered composer ([0960078](https://github.com/lezli01/vincent/commit/0960078a23c904e4ef69232c2bcf64a9ae53baf1))
* **tui:** give the new-chat form the picker every other form uses ([39f34b7](https://github.com/lezli01/vincent/commit/39f34b71896dac110bdfd0124c3f7cc50f00f705))
* **tui:** let the workflow editor write what it can read ([cb65290](https://github.com/lezli01/vincent/commit/cb652908b23420a851fa0910721e2de4e4bc73c2))
* **tui:** make a fan-out's lanes expandable rows on the board ([0371b61](https://github.com/lezli01/vincent/commit/0371b6158f4b922bd144ff5adeadf29cff8ae6ae))
* **tui:** make a fan-out's lanes reachable from the task workspace ([42a1f39](https://github.com/lezli01/vincent/commit/42a1f39c33cdb1a7b63fdfcd5bf2165294dfc21d)), closes [#316](https://github.com/lezli01/vincent/issues/316)
* **tui:** open a full step-detail modal from the workflow graph ([52d8465](https://github.com/lezli01/vincent/commit/52d8465c734d98597cc1e4f1226f5921d97b64e1))
* **tui:** read consecutive assistant records as one document ([8aae6b8](https://github.com/lezli01/vincent/commit/8aae6b892b4c3c4d4f946007c3e9921feae390a0))
* **tui:** render assistant prose as markdown in both output panes ([6fb7d87](https://github.com/lezli01/vincent/commit/6fb7d87bcb5646bd88cb15823dadff564f3c17e4))
* **tui:** render Markdown tables, links and highlighted code blocks ([dadd22b](https://github.com/lezli01/vincent/commit/dadd22b8bec58c0dd948cb4ba2514ac0397093d7))
* **tui:** scroll the chat conversation with the mouse wheel ([ba2c60a](https://github.com/lezli01/vincent/commit/ba2c60a2b6c822e7b0b4e08c29dee80183c427d6))
* **tui:** show real quota windows and offer claude's status line ([8117053](https://github.com/lezli01/vincent/commit/8117053e4475966c91754c6a6deeff8375b92074))
* **workflow:** add enum task fields and a default for every field type ([341bb38](https://github.com/lezli01/vincent/commit/341bb3830b951306f67e6b93a4f57ed4b7e9b6be))
* **workflow:** order fan-out lanes with needs and derive them at run time ([abc4132](https://github.com/lezli01/vincent/commit/abc41321282540c000a57e851311988eefbe3fcf))
* **workflow:** order fan-out lanes with needs and derive them at run time ([e89d7ba](https://github.com/lezli01/vincent/commit/e89d7ba9369522081c31cc97dbba36d0348cdb90))
* **workflow:** repair red checks and retry the merge in a loop ([62d195f](https://github.com/lezli01/vincent/commit/62d195f2e6f371a4ec10645c261e942c9473f39c))
* **workflows:** audit the site and merge the preparation PR in prepare-release ([2455318](https://github.com/lezli01/vincent/commit/24553183380715469c6af9847cb0a98c08dccced))
* **workflow:** schedule a fan_out's lanes eagerly ([94027f9](https://github.com/lezli01/vincent/commit/94027f94fb1e8a4ad5aa4ac07d973d94066441f5))
* **workflows:** resolve an issue as a DAG of parallel work units ([32f410e](https://github.com/lezli01/vincent/commit/32f410e614b4aeb79b23a1659794d6ded46ad4b6))
* **worktree:** fetch the base branch before cutting a task worktree ([3ad001a](https://github.com/lezli01/vincent/commit/3ad001a57373f21672021c200dbba99486316f8c))


### Bug Fixes

* **apiclient:** carry a fan-out's lane template, max_lanes and container ([066df85](https://github.com/lezli01/vincent/commit/066df85f8273cc3ca463b72bfc682c830bdf5f86))
* **chatrun:** drain the stream a turn abandons, so it cannot hang ([5446720](https://github.com/lezli01/vincent/commit/5446720a869b99cb3201a9bbed199e930e33d6dd))
* **config:** expose max_parallel_chats on the config read and patch surface ([295d64e](https://github.com/lezli01/vincent/commit/295d64ebf85c300309d73024c1363fd9ca3fa31a))
* **config:** judge extra_mounts paths POSIX-style on every platform ([2af6407](https://github.com/lezli01/vincent/commit/2af6407eee3b05b4f55f90a8a1ff461111713d0b))
* **container:** consult no runtime when a task asks for no container ([e6ef06e](https://github.com/lezli01/vincent/commit/e6ef06e5b363446ac813a47ff9732141c6a3d5d2))
* **gate:** give m2 scenario 5 a hold long enough to assert on ([7e8077c](https://github.com/lezli01/vincent/commit/7e8077c637ebdf879530cbd2b6b858300e213218))
* **mcp:** reconcile the MCP work with master ([f226a53](https://github.com/lezli01/vincent/commit/f226a53cb8119a7183b5e49a19b23ccb96d6b985))
* **store:** carry the admission hold through task insert ([5f40ee7](https://github.com/lezli01/vincent/commit/5f40ee760af0e381aab4ffdbca32b08d451cb9ea))
* take terminal chats off the chats board ([ea4963d](https://github.com/lezli01/vincent/commit/ea4963dcb8546b42d4df732bece56985117e0fa3))
* **taskrun:** render a command step's .Result from stdout alone ([6bb5c64](https://github.com/lezli01/vincent/commit/6bb5c64d51476acbfe47a4c026a41b09fc376bc9)), closes [#311](https://github.com/lezli01/vincent/issues/311)
* **taskrun:** store a command step's stdout tail at its own bound ([356ecea](https://github.com/lezli01/vincent/commit/356ecea3d29153907e859f13505ab856c1622f33))
* **tui:** draw a fan-out derived from a lane template ([feade51](https://github.com/lezli01/vincent/commit/feade515d02f3ac9a0eac5d05b3bc5585589fde3))
* **tui:** let the workflow editor read and address every block ([db80935](https://github.com/lezli01/vincent/commit/db809359759497184c50e470f0f86c9674d5474c))
* **tui:** make timeline tiers openable and keep the cursor drawn ([d195922](https://github.com/lezli01/vincent/commit/d1959220f7d12612edf1c7fe4914368fb2d76be2)), closes [#317](https://github.com/lezli01/vincent/issues/317)
* **tui:** name the workflow editor's structural keys in its own hint ([b801672](https://github.com/lezli01/vincent/commit/b801672929f42987c734172e7dd42dc4758864a6))
* **tui:** open the lane under the Diff tab's cursor, not the blamed one ([32345e0](https://github.com/lezli01/vincent/commit/32345e03dd66cf72bac791c61488422357279d73))
* **tui:** re-derive the workflow when the project-scoped catalog arrives ([09c936c](https://github.com/lezli01/vincent/commit/09c936c52642be7e31e82c26428ea4f71f09c361))
* **tui:** re-derive the workflow when the scoped catalog arrives ([8afc7e4](https://github.com/lezli01/vincent/commit/8afc7e4fc43ba6e41480c19df83e9df0abc8364f))
* **tui:** render a chat through the output pane at a shared level ([89b7d5b](https://github.com/lezli01/vincent/commit/89b7d5be428c5a3e021138f809e21f51b60e4cd0))
* **tui:** retire the registry event hook before the store closes ([224d7e9](https://github.com/lezli01/vincent/commit/224d7e996322b0071f5e71b0346d0fac5e7ac9d6))
* **tui:** synthesize any ctrl key when the palette replays an entry ([52f7013](https://github.com/lezli01/vincent/commit/52f70131f9b683611d4d37b0bcc12dae3efba88a))
* **tui:** wire the new-chat form's fetched pickers into the board ([65a590d](https://github.com/lezli01/vincent/commit/65a590d7cd98a28c0105a8c808b506e8ea838c44)), closes [#279](https://github.com/lezli01/vincent/issues/279)
* **tui:** wrap text fields at the pane width ([68faa8a](https://github.com/lezli01/vincent/commit/68faa8acca8cf52617700e85b0a54f5fe830f3f9))
* **tui:** wrap text fields at the pane width ([0ef2680](https://github.com/lezli01/vincent/commit/0ef268070b9d440ebfb4a5c702896c7cf9ab1efc))
* **workflow:** serve defaults.container in the schema descriptor ([68aa008](https://github.com/lezli01/vincent/commit/68aa0088db698e1f8937ba0a56976160736371a8))
