...
its own config and data dirs, seven git repos (one a GitHub project, answered by
`cmd/fakegh`), a daemon, fifteen tasks and four chats covering every state — and
