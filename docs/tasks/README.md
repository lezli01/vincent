...
| [049](049-full-screen-task-workspace.md) | Board-only home and full-screen task workspace | ✅ done (8/8) |
...
| [062](062-agent-steps-in-containers.md) | Agent steps inside the task's container | ✅ done (2/2) |
...
| [068](068-pull-request-tab.md) | Pull request tab on the task workspace, with checks and PR actions | ✅ done (5/5) |
| [069](069-open-a-pull-request-from-vincent.md) | Open a pull request from vincent itself | ✅ done (8/8) |
...
| [119](119-chat-on-a-step.md) | Chat on a stopped task: a conversation in the task's own worktree, locking the task while it is open | ✅ done (10/10) |
...
| [126](126-file-mentions.md) | File mentions in the chat composer: an `@` picker, and what each agent CLI does with a mention | 🔄 in progress (11/13) |
