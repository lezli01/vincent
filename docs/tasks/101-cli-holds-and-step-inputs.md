# 101 — Show admission holds and recorded step inputs in `vincent task show`
...
- [x] **101.1 — `apiclient.SplitFailureTrailer`, moved from the TUI's Step Details tab, with a round trip through `workflow.AppendFailureBlock`.** ✓ 2026-09-15
- [x] **101.2 — `internal/cli`: the `hold` row (`taskHoldRows`).** ✓ 2026-09-15
- [x] **101.3 — `internal/cli`: `task show --step` and the ASCII renderer in `taskstep.go`.** Depends: 101.1. ✓ 2026-09-15
- [x] **101.4 — The CLI reference, the §12.1 amendment and `CHANGELOG.md`.** ✓ 2026-09-15
