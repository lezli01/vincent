...
// TestNoSkillAndNoInputEcho is codex's half of a positive statement (task
// 124): `exec --json` has no skill item — a model reading a SKILL.md is a
// command like any other, and normalizes as agent.command_output — and codex
// echoes nothing of the prompt it was handed, so over every fixture no event
// is a skill load or an input echo (§9.3).
