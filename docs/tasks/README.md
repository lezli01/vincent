...
| [115](115-user-configurable-tui-keymap.md) | A user-configurable TUI keymap: `tui.keys` rebinds an operation on every surface, held to §15's three clauses | 🔄 in progress (3/6) |
